...
import type { VehicleSearchPrecondition } from "./booking-agent.interface";
...
export class VehicleSearchPreconditionPolicy {
  // Accept both 12-hour (9:00 AM) and 24-hour (09:00, 14:00) formats
  private readonly pickupTimePattern =
    /^(?:(1[0-2]|[1-9])(:[0-5]\d)?\s?(AM|PM)|([01]?\d|2[0-3]):[0-5]\d)$/i;
