...
import type { TwilioInboundWebhookPayload, WhatsAppMediaPayload } from "../booking-agent.interface";
 ...
 * and ListId/ListTitle for list replies.
 */
export function parseInteractiveReply(rawPayload: unknown): {
  ...
  // Check for button reply (Quick Reply button click)
