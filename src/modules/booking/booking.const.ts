...
export const BOOKING_PAYMENT_STATUS_TOKEN_GRACE_MS = 60 * 60 * 1000;
export const BOOKING_IDEMPOTENCY_RETENTION_MS = 24 * 60 * 60 * 1000;
export const BOOKING_CLIENT_CONTEXT_RETENTION_MS = 90 * 24 * 60 * 60 * 1000;
export const BOOKING_IDEMPOTENCY_PROCESSING_LEASE_MS = 60 * 1000;
export const BOOKING_IDEMPOTENCY_RETRY_AFTER_SECONDS = 5;
export const EXTENSION_IDEMPOTENCY_RETENTION_MS = 24 * 60 * 60 * 1000;
export const EXTENSION_IDEMPOTENCY_PROCESSING_LEASE_MS = 60 * 1000;
export const EXTENSION_IDEMPOTENCY_RETRY_AFTER_SECONDS = 5;
