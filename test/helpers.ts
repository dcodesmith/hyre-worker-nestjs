  ...
  async createCar(ownerId: string, options: CreateCarOptions = {}): Promise<{ id: string }> {
    const car = await this.prisma.car.create({
      data: {
        ...
        submittedAt: Object.hasOwn(options, "submittedAt") ? options.submittedAt : new Date(),
  ...
  async createPayment(
    ...
    const payment = await this.prisma.payment.create({
      data: {
        ...
        refundProviderId: options.refundProviderId,
        ...
        refundManualReviewNotifiedAt: options.refundManualReviewNotifiedAt,
      },
