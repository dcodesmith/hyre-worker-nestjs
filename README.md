...
OPERATIONS_EMAIL=operations@yourdomain.com
APP_NAME=Hyre
...
TWILIO_BOOKING_STATUS_UPDATE_CONTENT_SID=HXxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
TWILIO_CLIENT_BOOKING_LEG_START_REMINDER_CONTENT_SID=HXxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
TWILIO_CHAUFFEUR_BOOKING_LEG_START_REMINDER_CONTENT_SID=HXxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
TWILIO_CLIENT_BOOKING_LEG_END_REMINDER_CONTENT_SID=HXxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
TWILIO_CHAUFFEUR_BOOKING_LEG_END_REMINDER_CONTENT_SID=HXxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
TWILIO_BOOKING_CONFIRMATION_CONTENT_SID=HXxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
TWILIO_BOOKING_CANCELLATION_CLIENT_CONTENT_SID=HXxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
TWILIO_BOOKING_CANCELLATION_FLEET_OWNER_CONTENT_SID=HXxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
TWILIO_FLEET_OWNER_BOOKING_NOTIFICATION_CONTENT_SID=HXxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
...
# WhatsApp booking agent templates (same Content SIDs in every environment; optional overrides.
# Checkout tokens, prices, and image URLs still come from this environment.)
